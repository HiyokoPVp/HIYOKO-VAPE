                        ...
                        if dist > 4.5 then
                            ...
                            if (currentTime - lastAttackTime) > 0.45 then
                                ...
                                if sword and swordSlot then
                                    ...
                                    -- 既存の安全な破壊関数を使用（エフェクトとアニメーションを偽装）
